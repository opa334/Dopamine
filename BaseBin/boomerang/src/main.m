...
{
	setsid();
	gHandler = [[FCHandler alloc] initWithReceiveFilePath:fakeRootPath(@"basebin/.communication/launchd_to_boomerang") sendFilePath:fakeRootPath(@"basebin/.communication/boomerang_to_launchd")];
	getPrimitives();
	sendPrimitives();
	return 0;
}