...
uint64_t initPACPrimitives(uint64_t kernelAllocation)
{
	...
	kRegisterState *mappedState = (kRegisterState*)kaddr_to_pa(stack, NULL);
	...
	gFugu14KcallThread.scratchMemoryMapped = (uint64_t*)kaddr_to_pa(kernelAllocation + 0xF000ULL, NULL);
