...
{
	xpc_object_t message = xpc_dictionary_create_empty();
	xpc_dictionary_set_uint64(message, "id", JBD_SET_FAKELIB_MOUNT_ACTIVE);
...
int64_t jbdUnmount(const char *path, uint32_t flags)
{
	xpc_object_t message = xpc_dictionary_create_empty();
	xpc_dictionary_set_uint64(message, "id", JBD_UNMOUNT);
